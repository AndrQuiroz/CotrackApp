...
import com.cotrack.servicegps.BatteryAlertDialogFragment.BatteryAlertDialogListener;
import com.cotrack.servicegps.Constants.LocationUpdate;
import com.cotrack.servicegps.Constants.Ui;
import com.cotrack.servicegps.RecordLocationService.RecordLocationBinder;
...
public class MainActivity extends AppCompatActivity implements BatteryAlertDialogListener {
  ...
  public void onDialogPositiveClickWithChecked(DialogFragment dialog) {
    Log.d(TAG, "No se vuelve a mostrar el mensaje");
    ...
    switch (requestCode) {
      case REQUEST_CODE_ACCESS_FINE_LOCATION:
        ...
        if (grantResults.length == 0 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
          Toast.makeText(this, "Permiso de ubicacion no habilitado", Toast.LENGTH_SHORT).show();
        }
        checkPermission();
        break;
      ...
      case REQUEST_CODE_WRITE_EXTERNAL_STORAGE:
        // If request is cancelled, the result arrays are empty.
        if (grantResults.length == 0 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
          Toast.makeText(this, "Permiso de almacenamiento no habilitado", Toast.LENGTH_SHORT).show();
        }
        checkPermission();
        break;
      default:
